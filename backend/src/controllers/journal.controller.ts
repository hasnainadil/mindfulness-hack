...
async function createJournalController(req: Request, res: Response) {
  try {
...
async function deleteJournalController(req: Request, res: Response) {
  try {
    const userId = verifyToken(req.cookies.access_token);
...
async function getJournalsController(req: Request, res: Response) {
  try {
    const userId = verifyToken(req.cookies.access_token);
