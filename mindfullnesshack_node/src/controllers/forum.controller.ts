...
export async function getQuestionsController(req: Request, res: Response) {
    try {
...
export async function likeDislikeQuestionController(req: Request, res: Response) {
    try {
        // Like a question
        const questionId = parseInt(req.params.questionId);
...
export async function createQuestionReplyController(req: Request, res: Response) {
    try {
...
export async function getRepliesController(req: Request, res: Response) {
    try {
...
export async function likeDislikeReplyController(req: Request, res: Response) {
    try {
        // Like a reply
...
export async function deleteQuestionReplyController(req: Request, res: Response) {
    try {
        // Delete a reply
        const replyId = parseInt(req.params.replyId);
